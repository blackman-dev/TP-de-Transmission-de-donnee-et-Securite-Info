...
package tp_trans_donnee_securite_info.dechiffrement;

class Program_dechiffrement {
  ...
  public static int decrypt(int input) {
    ...
    int permutedInput = permute(input, permutation);
    
    // Sépare l'entrée en deux blocs de 4 bits
    int g2 = permutedInput >>> 4;
    int d2 = permutedInput & 0b1111;
  ...
  private static int reversePermute(int input) {
   ...
   public static void main(String[] args) {
        ...
        int C = 0b10101010;
        int decrypted = Program_dechiffrement.decrypt(C);
 ...
 */
        /*
public class Program_dechiffrement {
